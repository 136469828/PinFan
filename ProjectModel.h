...
@property (nonatomic, copy) NSString *manPric;           // 男价
@property (nonatomic, copy) NSString *femalePrice;           // 女价
@property (nonatomic, copy) NSString *femaleSum;           // 女数
@property (nonatomic, copy) NSString *manSum;           // 男数
