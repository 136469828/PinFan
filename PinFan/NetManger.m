...
- (void)advertiseGetlist
{
    ...
    NSString *url = [NSString stringWithFormat:@"%@article/advertise/getlist",ServerAddressURL ];
    [manger POST:url parameters:parameters success:^(AFHTTPRequestOperation * _Nonnull operation, id  _Nonnull responseObject)
     {
...
- (void)homeGetprojectlistWithKeyword:(BOOL) iskeyword AndKeyword:(NSString *)keyword
{
    ...
    NSString *url = [NSString stringWithFormat:@"%@product/caixi/getcaixilist",ServerAddressURL];
    [manger POST:url parameters:parameters success:^(AFHTTPRequestOperation * _Nonnull operation, id  _Nonnull responseObject)
     {
...
//             model.money            = [NSString stringWithFormat:@"%@",dic[@"icon"]];
             model.projectImg       = [NSString stringWithFormat:@"%@",dic[@"icon"]];
             model.projectName      = [NSString stringWithFormat:@"%@",dic[@"Name"]];
             model.manPric          = [NSString stringWithFormat:@"%@",dic[@"manPric"]];
             model.femalePrice      = [NSString stringWithFormat:@"%@",dic[@"femalePrice"]];
             model.manSum           = [NSString stringWithFormat:@"%@",dic[@"manSum"]];
             model.femaleSum        = [NSString stringWithFormat:@"%@",dic[@"femaleSum"]];
             model.projectIDofModel = [NSString stringWithFormat:@"%@",dic[@"Id"]];
...
#pragma mark - 项目列表（产品列表）
- (void)getproductlistWithKeyword:(BOOL) iskeyword AndKeyword:(NSString *)keyword
{
    AFHTTPRequestOperationManager *manger = [AFHTTPRequestOperationManager manager];
    manger.requestSerializer.timeoutInterval = 5;
    NSDictionary *parameters = [[NSDictionary alloc] init];
    ...
    NSString *url = [NSString stringWithFormat:@"%@product/product/getproductlist",ServerAddressURL];
    [manger POST:url parameters:parameters success:^(AFHTTPRequestOperation * _Nonnull operation, id  _Nonnull responseObject)
     {
         NSLog(@"项目列表：%@",responseObject);
         NSArray *dataLists = responseObject[@"data"][@"DataList"];
         ...
         for (NSDictionary *dic in dataLists) {
             ...
             //             model.classTypeName      = [NSString stringWithFormat:@"%@",dic[@"ClassTypeName"]];
             //             model.status           = [NSString stringWithFormat:@"%@",dic[@"Status"]];
             model.money            = [NSString stringWithFormat:@"%@",dic[@"SalePrice"]];
             model.projectImg       = [NSString stringWithFormat:@"%@",dic[@"icon"]];
             model.projectName      = [NSString stringWithFormat:@"%@",dic[@"ProductName"]];
             model.manPric          = [NSString stringWithFormat:@"%@",dic[@"manPric"]];
             model.femalePrice      = [NSString stringWithFormat:@"%@",dic[@"femalePrice"]];
             model.manSum           = [NSString stringWithFormat:@"%@",dic[@"manSum"]];
             model.femaleSum        = [NSString stringWithFormat:@"%@",dic[@"femaleSum"]];
